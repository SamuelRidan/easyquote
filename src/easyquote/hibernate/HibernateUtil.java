...
import easyquote.modelo.Configuracao;
import easyquote.util.Util;
import easyquote.util.UtilReflection;
...
public class HibernateUtil {
	...
	@SuppressWarnings("rawtypes")
	public List retorna1HQL(String hql) {
	...
	public long executarCountHQL(String hql) {
